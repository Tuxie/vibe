...
The retrospective template (`retrospective-template.md`) summarises these per-analyst records into the run-level `Senior-1M usage:` and `Effort overrides:` lines.
